...
import {addItem, inreaseItemQuantity, clearCart} from "../cart/cartSlice";

function CartButton({itemQuantity}) {
  const dispatch = useDispatch();
  const {name, price, quantity, id} = useSelector((state) => state.product);
  ...
  return (
    <button className={classes.btnCart} onClick={addToCartHandler}>
      {/* <img src={logo} className={classes.cartImg} /> */}
      <svg
